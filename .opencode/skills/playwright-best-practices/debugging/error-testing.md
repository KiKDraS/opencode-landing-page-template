...
Covers **unexpected network failures** + error recovery. **Offline-first apps (PWAs)** w/ service workers, caching, background sync: [service-workers.md](service-workers.md#offline-testing).
